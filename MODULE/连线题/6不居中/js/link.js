    ...
    for(var i =0 ; i < unique.leftCount; i ++){
        ...
        if(((content.length-temp3)*temp[0]+temp3*temp[0]*0.85) >= (lists[i].clientWidth - temp2[0])){
            if(/(Android)/i.test(navigator.userAgent)){
                lists[i].setAttribute("style","padding-top:1.557%;padding-bottom:1.557%"); 
            }
            else if(/(iPhone|iPad|iPod|iOS)/i.test(navigator.userAgent)){
                lists[i].setAttribute("style","padding-top: 1.36%;padding-bottom: 1.36%;");   
            }
            else {
                lists[i].setAttribute("style","padding-top:2.78%;padding-bottom:2.78%"); 
            }
        }   
    }
    ...
    for(var i =0 ; i < unique.rightCount; i ++){
        ...
        if(((content.length-temp3)*temp[0]+temp3*temp[0]*0.85) >= (lists[i].clientWidth - temp2[0])){
            if(/(Android)/i.test(navigator.userAgent)){
                ...
                lists[i].setAttribute("style","padding-top:0.521%;padding-bottom: 0.521%;");   
            }
            else {
                lists[i].setAttribute("style","padding-top:1.064%;padding-bottom:1.064%"); 
            }
        }
    }
