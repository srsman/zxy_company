    ...
    for(var i =0 ; i < unique.leftCount; i ++){
        ...
        var temp3 = findNotChinese(content);
            ...
            if(/(Android)/i.test(navigator.userAgent)){
                lists[i].setAttribute("style","padding-top:1.317%;padding-bottom:1.317%"); 
            }
            else if(/(iPhone|iPad|iPod|iOS)/i.test(navigator.userAgent)){
                lists[i].setAttribute("style","padding-top: 1.131%;padding-bottom: 1.131%;");   
            }
            else {
                lists[i].setAttribute("style","padding-top:1.484%;padding-bottom:1.484%"); 
            }
        }   
    }
