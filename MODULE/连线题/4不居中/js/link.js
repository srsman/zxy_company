...
//                console.log(rightTop);
    ...
    if(navigator.userAgent.toLowerCase().match(/msie ([\d.]+)/)){
        ...
        if(((content.length-temp3)*temp[0]+temp3*temp[0]*0.85) >= (lists[i].clientWidth - temp2[0])){
                ...
                lists[i].setAttribute("style","padding-top:2.965%;padding-bottom:2.965%"); 
                if(/(Android)/i.test(navigator.userAgent)){
                    lists[i].setAttribute("style","padding-top:2.64%;padding-bottom:2.64%"); 
                }
                else if(/(iPhone|iPad|iPod|iOS)/i.test(navigator.userAgent)){
                    lists[i].setAttribute("style","padding-top: 3.633%;padding-bottom: 3.633%;");   
                }
            }   
        }
        ...
        if(((content.length-temp3)*temp[0]+temp3*temp[0]*0.85) >= (lists[i].clientWidth - temp2[0])){
                console.log("change style");
                lists[i].setAttribute("style","padding-top:1.13%;padding-bottom:1.136%");
                if(/(Android)/i.test(navigator.userAgent)){
                    lists[i].setAttribute("style","padding-top:1.012%;padding-bottom:1.012%"); 
                }
                else if(/(iPhone|iPad|iPod|iOS)/i.test(navigator.userAgent)){
                    lists[i].setAttribute("style","padding-top: 1.393%;padding-bottom: 1.393%;");   
                }
            }
        }
