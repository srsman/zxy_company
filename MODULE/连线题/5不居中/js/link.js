...
//    }
    ...
    for(var i =0 ; i < unique.leftCount; i ++){
        ...
        if(((content.length-temp3)*temp[0]+temp3*temp[0]*0.85) >= (lists[i].clientWidth - temp2[0])){
            if(/(Android)/i.test(navigator.userAgent)){
                lists[i].setAttribute("style","padding-top:2.633%;padding-bottom:2.633%"); 
            }
            else if(/(iPhone|iPad|iPod|iOS)/i.test(navigator.userAgent)){
                lists[i].setAttribute("style","padding-top: 2.261%;padding-bottom: 2.261%;");   
            }
            else {
                lists[i].setAttribute("style","padding-top:3.26%;padding-bottom:3.26%"); 
            }
        }   
    }
    ...
    for(var i =0 ; i < unique.rightCount; i ++){
        ...
        if(((content.length-temp3)*temp[0]+temp3*temp[0]*0.85) >= (lists[i].clientWidth - temp2[0])){
            if(/(Android)/i.test(navigator.userAgent)){
                lists[i].setAttribute("style","padding-top:1.01%;padding-bottom:1.01%"); 
            }
            else if(/(iPhone|iPad|iPod|iOS)/i.test(navigator.userAgent)){
                lists[i].setAttribute("style","padding-top:0.867%;padding-bottom:0.867%;");   
            }
            else {
                lists[i].setAttribute("style","padding-top:1.25%;padding-bottom:1.25%"); 
            }
        }
    }
