...
//            document.getElementById("bigger").setAttribute("style", "width:"+showWidth+"px;height:"+showHeight+"px;top:15.45%");
//        }
        
    }
    
//    if(/(iPhone|iPad|iPod|iOS)/i.test(navigator.userAgent)){
//        document.getElementById("submitBtn").setAttribute("style","top:87.5%;"); 
//        document.getElementById("tip").setAttribute("style","top:89.4%;");
//    }
    ...
    for(var i =0 ; i < unique.leftCount; i ++){
        ...
        if(((content.length-temp3)*temp[0]+temp3*temp[0]*0.85) >= (lists[i].clientWidth - temp2[0])){
            if(/(Android)/i.test(navigator.userAgent)){
                lists[i].setAttribute("style","padding-top:6.634%;padding-bottom:6.634%"); 
            }
            else if(/(iPhone|iPad|iPod|iOS)/i.test(navigator.userAgent)){
                lists[i].setAttribute("style","padding-top: 5.644%;padding-bottom: 5.644%;");   
            }
            else {
                lists[i].setAttribute("style","padding-top:4.805%;padding-bottom:4.805%"); 
            }
        }   
    }
    ...
    for(var i =0 ; i < unique.rightCount; i ++){
        ...
        if(((content.length-temp3)*temp[0]+temp3*temp[0]*0.85) >= (lists[i].clientWidth - temp2[0])){
            if(/(Android)/i.test(navigator.userAgent)){
                lists[i].setAttribute("style","padding-top:2.543%;padding-bottom:2.543%;"); 
            }
            else if(/(iPhone|iPad|iPod|iOS)/i.test(navigator.userAgent)){
                lists[i].setAttribute("style","padding-top: 2.164%;padding-bottom: 2.164%;");   
            }
            else {
                lists[i].setAttribute("style","padding-top:1.843%;padding-bottom:1.843%"); 
            }
        }
    }
